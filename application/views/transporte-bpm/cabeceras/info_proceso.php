          ...
          <div class="col-md-12">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control habilitar" id="generador"
                  value="<?php echo $aux->solicitud->soco_id; ?>" readonly>
              </div>
            </div>
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control habilitar" id="pedido"
                  value="<?php echo $aux->solicitud->estado; ?>" readonly>
              </div>
            </div>
            <!--_____________________________________________-->
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control habilitar" id="domicilio"
                  value="<?php echo $aux->solicitud->observaciones; ?>" readonly>
              </div>
            </div>
            <!--_____________________________________________-->
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control habilitar" id="fec_alta"
                  value="<?php echo $aux->solicitud->fec_alta; ?>" readonly>
              </div>
            </div>
            <!--_____________________________________________-->
          ...
          <div class="col-md-12">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control habilitar" id="generador" value="<?php echo $aux->sore_id; ?>"
                  readonly>
              </div>
            </div>
            <!--_____________________________________________-->
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control habilitar" id="pedido" value="<?php echo $aux->fec_alta; ?>"
                  readonly>
              </div>
            </div>
            <!--_____________________________________________-->
          ...
          <div class="col-md-12">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control habilitar" id="O_Transporte" value="<?php echo $aux->ortr_id; ?>"
                  readonly>
              </div>
            </div>
            <!--_____________________________________________-->
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control habilitar" id="f_Alta" value="<?php echo $aux->fec_alta; ?>"
                  readonly>
              </div>
            </div>
            <!--_____________________________________________-->
          ...
          <div class="col-md-12">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control habilitar" id="patente" value="<?php echo $aux->dominio; ?>"
                  readonly>
              </div>
            </div>
            <!--_____________________________________________-->
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control habilitar" id="desc_vehiculo"
                  value="<?php echo $aux->descripcion; ?>" readonly>
              </div>
            </div>
            <!--_____________________________________________-->
          </div>
          ...
          <div class="col-md-12">
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control habilitar" id="nom_chof" value="<?php echo $aux->nom_chofer; ?>"
                  readonly>
              </div>
            </div>
            <!--_____________________________________________-->
            ...
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control habilitar" id="f_Alta" value="<?php echo $aux->documento; ?>"
                  readonly>
              </div>
            </div>
            <!--_____________________________________________-->
