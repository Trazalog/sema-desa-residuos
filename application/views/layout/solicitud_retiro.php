...
<div class="box box-primary animated fadeInLeft">
    <div class="box-header with-border">
        <h4>Template solicitud de retiro</h4>
    </div>
                                ...
                                <thead>
                                    <tr role="row">
                                        <th class="sorting_asc" tabindex="0" aria-controls="example2" rowspan="1"
                                            ...
                                            solicitud</th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                            colspan="1" aria-label="Browser: activate to sort column ascending">Tipo de
                                            residuo
                                        </th>
                                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control input-sm" value="<?php echo $fecha;?>"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control input-sm" rows="5" id="descripcion"
                            ...
                            <table id="tablamodal" class="table table-condensed table-bordered table-hover" role="grid"
                                ...
                                <tbody id="tabadd">
                                    ...
                                    <tr role="row" class="even" id="primero">
                                        ...
                                        <td>4/10/2019</td>
                                        <td>Motivo 2</td>
                                        <td>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit,
                                            quis! Aut assumenda enim quisquam.</td>
                                        <td></td>
                                    </tr>
                                    <tr role="row" class="even" id="primero">
                                        <td>5</td>
...
<!-- Modal Entrega-->
<div class="modal fade" id="modalEntrega" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="generador" name="generador" required
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="rectificatoria" required name="rectificatoria"
                                    class="form-control input-sm">
                            </div>
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" id="fecharet" required name="fecharetiro"
                                    class="form-control input-sm">
                            </div>
                        </div>
                    </div>
