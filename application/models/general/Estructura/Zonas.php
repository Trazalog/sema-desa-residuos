...
{
    log_message('DEBUG', 'Zonas/obtener_Vehiculo');
...
{
    log_message('DEBUG', 'Zonas/obtener_Chofer');
...
{
    log_message('DEBUG', 'Zonas/obtener_Departamentos');
...
{
    log_message('DEBUG', 'Zonas/obtener_Zona');
    $aux = $this->rest->callAPI("GET",REST."/zonas");
    wso2Msj($aux);
    $aux =json_decode($aux["data"]);
    return $aux->zonas->Zona;
...
{
    log_message('DEBUG', 'Zonas/obtener_Circuitos_Asignados');
    $aux = $this->rest->callAPI("GET",REST."/RECURSO");
    wso2Msj($aux);
    $aux =json_decode($aux["data"]);
    return $aux->circuitos->circuito;
